...
# 2 "<built-in>" 2
# 1 "softuart/softusart.c" 2
# 11 "softuart/softusart.c"
...
# 11 "softuart/softusart.c" 2

# 1 "softuart/softusart.h" 1
# 33 "softuart/softusart.h"
...
void softusart_yaz(char veri)
{
 char i;
 LATDbits.LD6=0;
 _delay((8000000/4) / 9600 -11);
 for(i=8;i>0;i--)
 {
  veri=veri>>1;
  LATDbits.LD6=CARRY;
  _delay((8000000/4) / 9600 -16);
 }
 LATDbits.LD6=1;
 _delay((8000000/4) / 9600);
}
...
char softusart_oku(void)
{
 ...
 for(i=8;i>0;i--)
 {
  ...
  _delay((8000000/4) / 9600 -29);
 }


 _delay((8000000/4) / 9600/2);
 while(!PORTDbits.RD5);
 return temp;
}
